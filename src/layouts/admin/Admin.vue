...
let dynamicCssPath = [
    ...
    '/src/assets/admin/css/metisMenu.min.css',
    '/src/assets/admin/css/timeline.css',
    '/src/assets/admin/css/startmin.css',
    '/src/assets/admin/css/morris.css',
];
...
let scriptTag = [
    ...
    '/src/assets/admin/js/metisMenu.min.js',
    '/src/assets/admin/js/raphael.min.js',
    '/src/assets/admin/js/morris.min.js',
    '/src/assets/admin/js/morris-data.js',
    '/src/assets/admin/js/startmin.js',
];
